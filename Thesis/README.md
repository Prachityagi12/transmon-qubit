...
- Resonator spectroscopy and parameter extraction using Lorentzian fitting
- Dispersive regime analysis and photon-number splitting
- Qubit spectroscopy and adaptive spectroscopy methods
- Anharmonicity extraction of the transmon qubit
- Power broadening analysis
- Time-domain characterization including Rabi oscillations, Ramsey interference, and coherence measurements
